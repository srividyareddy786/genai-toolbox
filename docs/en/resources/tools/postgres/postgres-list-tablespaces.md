...
weight: 1
description: >
 The "postgres-list-tablespaces" tool lists indexes in a Postgres database.
aliases:
...
- `name` (optional): A text to filter results by tablespace name. The input is used within a LIKE clause. Default: `""`
